...
Every developer took their time testing their code locally. Our Source control give error for any code that conflicts with master. After each GitHub merge another test was done. Finally we test the general application daily to figure out bugs and have users view. Our full suite of tests can be found [here](https://docs.google.com/spreadsheets/d/17yKq2rUzpn3wFPGTKNGa569O390hjrnVKPHrcpv_P44/edit).
